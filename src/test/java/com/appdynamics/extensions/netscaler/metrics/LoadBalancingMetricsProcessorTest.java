 ...
 */
public class LoadBalancingMetricsProcessorTest {
    ...
    public void setup() throws IOException {
        ...
        entity.setContent(new FileInputStream("src/test/resources/json/loadbalancing.json"));
    }

    @Test
    public void getLoadBalancingMetricsTest() throws IOException {
        ...
        List<Map> lbMetricsFromCfg = (List) allMetrics.get("Load Balancing");
        LoadBalancingMetricsProcessor lbMetricsProcessor = new LoadBalancingMetricsProcessor(configuration, metricWriteHelper,
                "serverURL", "server1", lbMetricsFromCfg, latch);
        lbMetricsProcessor.run();
    ...
    private List<String> metricNamesFromAPI() {
        List<String> lbMetricNamesFromAPI = Lists.newArrayList();
        lbMetricNamesFromAPI.add("tothits");
        lbMetricNamesFromAPI.add("totalrequests");
        lbMetricNamesFromAPI.add("responsesrate");
        lbMetricNamesFromAPI.add("totalresponses");
        lbMetricNamesFromAPI.add("curclntconnections");
        lbMetricNamesFromAPI.add("cursrvrconnections");
        lbMetricNamesFromAPI.add("state");
        return lbMetricNamesFromAPI;
    }
}
